...
enum L10n {
    ...
    static let table: [SupportedLanguage: [String: String]] = [
        .ru: [
            ...
            "today.summary.spent": "Потрачено",
            "today.summary.remaining": "Осталось",
            "today.summary.status": "Статус",
            "today.empty.title": "Траты еще не добавлены",
            "today.empty.subtitle": "Откройте день и внесите первую запись, чтобы заполнить его.",
        ...
        .en: [
            ...
            "today.summary.spent": "Spent",
            "today.summary.remaining": "Remaining",
            "today.summary.status": "Status",
            "today.empty.title": "No spends yet",
            "today.empty.subtitle": "Open this day and add the first entry to fill it.",
        ...
        .de: [
            ...
            "today.summary.spent": "Ausgegeben",
            "today.summary.remaining": "Uebrig",
            "today.summary.status": "Status",
            "today.empty.title": "Noch keine Ausgaben",
            "today.empty.subtitle": "Oeffne diesen Tag und fuege den ersten Eintrag hinzu.",
